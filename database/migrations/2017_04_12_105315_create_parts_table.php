...
class CreatePartsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('parts', function (Blueprint $table) {
            ...
            $table->date('SA_FITTING_DATE')->nullable();
            $table->double('SA_WELDING', 6, 2)->default(0);
            $table->date('SA_WELDING_DATE')->nullable();
            $table->double('SA_GRINDING', 6, 2)->default(0);
            $table->date('SA_GRINDING_DATE')->nullable();
            $table->double('SA_FAIRING', 6, 2)->default(0);
            $table->date('SA_FAIRING_DATE')->nullable();
            $table->double('A_FITTING', 6, 2)->default(0);
            $table->date('A_FITTING_DATE')->nullable();
            $table->double('A_WELDING', 6, 2)->default(0);
            $table->date('A_WELDING_DATE')->nullable();
            $table->double('A_GRINDING', 6, 2)->default(0);
            $table->date('A_GRINDING_DATE')->nullable();
            $table->double('A_FAIRING', 6, 2)->default(0);
            $table->date('A_FAIRING_DATE')->nullable();
            $table->timestamps();
        });
    }
